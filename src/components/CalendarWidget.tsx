            ...
            >
              {d.day > 0 && (
                <>
                  ...
                  {circleSize > 0 && (
                    <div
                      className="bg-[var(--color-accent)]/25 absolute rounded-full transition-all duration-200"
                      style={{
                        width: `${circleSize}px`,
                  ...
                  <span
                    className={`relative text-[10px] font-medium leading-none transition-all ${
                      isHovered
                        ? 'text-[var(--color-text)]'
                        : d.activities.length > 0
