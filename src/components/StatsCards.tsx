...
export function StatsCards({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-[1fr_1fr_1fr_1.6fr]">
      {/* Yearly Goal */}
      <div className="hover:shadow-[var(--color-accent)]/5 hover:border-[var(--color-accent)]/30 hover:bg-[var(--color-accent)]/5 rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-5 transition-all duration-300 hover:shadow-lg">
        <p className="mb-2 flex items-center gap-1.5 text-xs uppercase tracking-wider text-[var(--color-muted)]">
          <svg
        ...
        <p className="whitespace-nowrap font-mono text-3xl font-bold">
          {goal.unit === 'time'
            ...
            <div className="mt-3 flex items-center gap-2">
              <div className="flex shrink-0 flex-col items-center gap-0">
                <div className="relative h-9 w-9">
                  ...
                  <span className="absolute bottom-[18%] left-0 right-0 flex items-center justify-center text-[9px] font-bold leading-none text-white">
                    {currentWeekStreak}
                  </span>
                </div>
