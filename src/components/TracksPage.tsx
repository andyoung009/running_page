      ...
      <div className="grid grid-cols-1 items-start gap-5 lg:grid-cols-[340px_1fr]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-4">
            <p className="mb-3 text-[10px] uppercase tracking-wider text-[var(--color-muted)]">
                ...
                {[...clusteredTracks]
                  ...
                  .map(({ representative: a, count, color }) => (
                    <div key={a.run_id} className="relative">
                      ...
                      />
                      {count > 1 && (
                        <span className="bg-[var(--color-bg)]/80 pointer-events-none absolute bottom-1 right-1 rounded px-1 py-0.5 text-[9px] font-bold leading-none text-[var(--color-muted)]">
                          ×{count}
                        </span>
                      )}
                    </div>
